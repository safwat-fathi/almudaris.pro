...
export default function SessionsHeader({ onNewSession }: SessionsHeaderProps) {
  return (
    <div className="flex justify-between items-center mb-8 px-2 md:px-0">
      ...
      <button
        ...
        className="flex items-center gap-2 bg-primary text-on-primary px-5 py-3 rounded-full hover:bg-primary/90 transition-colors shadow-sm cursor-pointer whitespace-nowrap"
      >
