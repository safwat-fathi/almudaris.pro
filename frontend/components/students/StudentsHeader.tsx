...
export default function StudentsHeader() {
  return (
    <header className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
      <div>
        <h2 className="font-headline text-3xl md:text-4xl font-extrabold text-on-surface mb-2">الطلاب</h2>
        <p className="text-on-surface-variant font-body text-lg">إدارة قائمة الطلاب والمشاركين في دوراتك الأكاديمية</p>
      </div>
      <Link 
