    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
      <div className="bg-primary-container p-6 rounded-xl text-on-primary-container flex flex-col justify-between h-40 shadow-sm">
        ...
        <div className="flex items-baseline gap-2">
          <span className="text-5xl font-bold font-headline">{mockStats.totalStudents}</span>
      ...
      <div className="bg-surface-container-low p-6 rounded-xl flex flex-col justify-between h-40">
        ...
        <div className="flex items-baseline gap-2">
          <span className="text-5xl font-bold font-headline text-secondary">{mockStats.collectionRate}</span>
      ...
      <div className="bg-surface-container-low p-6 rounded-xl flex flex-col justify-between h-40">
        ...
        <div className="flex items-baseline gap-2">
          <span className="text-5xl font-bold font-headline text-primary">{mockStats.activeSessions}</span>
