  ...
  return (
    <div className="bg-surface text-on-surface antialiased min-h-screen flex flex-col pb-32">
      ...
      <header className="bg-surface sticky top-0 z-50 transition-colors duration-200 ease-in-out">
        <div className="flex items-center gap-4 px-8 py-4 w-full max-w-full">
          <Link href="/student-dashboard/homework" className="w-10 h-10 flex items-center justify-center rounded-full hover:bg-surface-container-high active:scale-95 transition-all text-on-surface-variant">
