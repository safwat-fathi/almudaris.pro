			...
			<header className="w-full top-0 sticky z-50 bg-surface-container-lowest/85 backdrop-blur-md border-b border-outline-variant/10">
				<div className="flex justify-between items-center px-6 md:px-12 py-4 w-full">
					<div className="flex items-center gap-4">
						<Link
							href="/students"
							className="material-symbols-outlined text-slate-500 hover:bg-slate-200/50 transition-colors p-2 rounded-full active:scale-95 duration-150 ease-in-out"
						>
							arrow_back
						</Link>
					...
					>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
							<div className="flex flex-col gap-2">
								<label className="font-body text-sm font-semibold text-on-surface-variant px-1">
									اسم الطالب
								</label>
						...
						<div className="flex flex-col gap-2">
							<div className="flex justify-between items-center px-1">
								<label className="font-body text-sm font-semibold text-on-surface-variant">
									الدفعة / المجموعة <span className="text-error">*</span>
								</label>
						...
						<div className="flex gap-4 p-5 bg-blue-50/50 rounded-xl items-start border border-blue-100 mt-2">
							...
							<p className="text-sm leading-relaxed text-blue-900/80 font-body">
								بمجرد النقر على &quot;إنشاء رابط الدعوة&quot;، سيتم توليد رابط
								فريد يمكنك مشاركته مع الطالب عبر الواتساب أو منصات التواصل
								الاجتماعي.
							</p>
						</div>
