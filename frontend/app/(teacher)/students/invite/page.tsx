          ...
          <form onSubmit={handleGenerate} className="p-8 md:p-12 flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="flex flex-col gap-2">
                <label className="font-body text-sm font-semibold text-on-surface-variant px-1">اسم الطالب</label>
              ...
              <div className="flex flex-col gap-2">
                <label className="font-body text-sm font-semibold text-on-surface-variant px-1">رقم هاتف ولي الأمر</label>
                <div className="relative">
                  <input 
