...
- These guidelines applies to the entire `al-mudaris-pro` project.
...
- Always add swagger decorators (@ApiTags, @ApiOperation, @ApiResponse, @ApiBody, etc.) to all controllers routes.
...
- Always add @ApiBearerAuth(CONSTANTS.ACCESS_TOKEN) to all protected routes.
